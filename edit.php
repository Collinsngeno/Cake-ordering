<?php
 ...
 mysqli_query($connect,"UPDATE pricelist SET Productcode='$Productcode',Cakename='$Cakename', Quantity='$Quantity',Price='$Price' WHERE Productcode='$Productcode'")
 or die(mysqli_error()); 
 ...
 $result = mysqli_query($connect,"SELECT * FROM pricelist WHERE Productcode=$Productcode")
 or die(mysqli_error()); 
 ...
 $Price = $row['Price'];
 // show form
 renderForm($Productcode, $Cakename, $Quantity, $Price, '');
 }
 else
