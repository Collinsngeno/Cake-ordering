...
*/
 ...
 $Productcode = mysqli_real_escape_string($connect,htmlspecialchars($_POST['Productcode']));
 ...
 mysqli_query($connect,"INSERT products SET Productcode='$Productcode', Cakename='$Cakename', Price='$Price'")
 or die(mysqli_error()); 
